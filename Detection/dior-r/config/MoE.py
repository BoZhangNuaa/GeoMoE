...
optim_wrapper = dict(
    ...
    optimizer=dict(
        betas=(0.9,0.999,), lr=8e-5, type='AdamW', weight_decay=0.05),
    paramwise_cfg=dict(layer_decay_rate=0.8))

#################################### dataset ################################################

# dataset settings
dataset_type = 'DIORDataset_'
data_root = '/data/bozhang/ICASSP/dior-r'
backend_args = None
